...
module.exports = {
  ...
  checkUpdates: function () {
    const checkUpdates = {
      type: "list",
      name: "checkUpdates",
      message: "Do you want to check for install packages?",
      choices: ["yes", "no"],
      default: "yes"
    }
  ...
  installNCU: function () {
    const installNCU = {
      type: "list",
      name: "installNCU",
      message: "Do you want to install npm-check-updates? (This checks your package.json file and updates dependencies)",
      choices: ["yes", "no"],
      default: "yes"
    }
